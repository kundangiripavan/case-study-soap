 ...
 * 
 */
@WebServiceClient(name = "ProductServiceImplService", targetNamespace = "http://prodsvc.training.com", wsdlLocation = "http://localhost:8081/product/services/ProductServiceImpl?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8081/product/services/ProductServiceImpl?wsdl");
